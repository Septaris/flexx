...
class Asset:
    ...
    subclass, the asset will be detected by Flexx. It will automatically
    be loaded on the page, unless its a lazy asset, in which case the asset
    is only included on the page if a module is actually used.
